          ...
          $nom2 = '';
            foreach ($query->result() as $jt) {
              ...
              if($nom1 != $nom2) {
                ...
                $this->dbmain->insert('qtemp_akun_neraca', array('temp1_urut'=>str_pad($jturut, 2, '0', STR_PAD_LEFT),'temp1_noper'=>substr($jt->aktrx_nomor,0,3),'temp1_perk'=>'SUBTOTAL-1','temp1_da'=>$tnida,'temp1_ka'=>$tnika,'temp1_db'=>$tnidb,'temp1_kb'=>$tnikb,'temp1_dc'=>$tnidc,'temp1_kc'=>$tnikc,'temp1_akses'=>$nikpeg));
                $jturut++;
              }
              $this->dbmain->insert('qtemp_akun_neraca', array('temp1_urut'=>str_pad($jturut, 2, '0', STR_PAD_LEFT),'temp1_noper'=>$jt->aktrx_nomor,'temp1_perk'=>$jt->aktrx_nama,'temp1_da'=>$ida,'temp1_ka'=>$ika,'temp1_db'=>$idb,'temp1_kb'=>$ikb,'temp1_dc'=>$idc,'temp1_kc'=>$ikc,'temp1_akses'=>$nikpeg));
              $nom2 = substr($jt->aktrx_nomor,0,3);

              $li++;
              if($li == $jumloop) {
                $this->dbmain->insert('qtemp_akun_neraca', array('temp1_urut'=>str_pad($jturut+1, 2, '0', STR_PAD_LEFT),'temp1_noper'=>'','temp1_perk'=>'SUBTOTAL-2','temp1_da'=>$tida,'temp1_ka'=>$tika,'temp1_db'=>$tidb,'temp1_kb'=>$tikb,'temp1_dc'=>$tidc,'temp1_kc'=>$tikc,'temp1_akses'=>$nikpeg));
                $tida = 0;
                $tika = 0;
                $tidb = 0;
                $tikb = 0;
...
//      $this->dbmain->where('concat(ka_3,\'.\',ka_4,\'.\',ka_5)',$ncarup1);
    ...
    public function hitungtrx($param1 = FALSE,$param2 = FALSE){
//      $waktu = array();
      if($param1 == 'thn'){
