                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                                ...
                                ?>
                                <select id="ft_jns" class="form-control"></select>;
                              </div>
                              <div class="col-md-6 col-sm-12 col-xs-12">
                                <?php
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            ?>
                            <select id="ft_nmr2" class="form-control" style="width: 100%;float: left;"></select>;
                        </div>
                        ...
                        <div class="input-group input-group-sm">
                          ...
                          <input id="ft_mark1" name="ft_urut" type="hidden">
        ...
        <div class="x_panel">
            <div class="x_title">
              <h2 class="grid__item theme-9">
      					<button class="helum particles-button" onclick="cekback();"><i class="fa fa-hand-o-left red"></i> Kembali</button>
      				</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                </ul>
